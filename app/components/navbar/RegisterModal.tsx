...
const RegisterModal: React.FC<RegisterModalProps> = ({
  ...
  return (
    <div className=" transition duration-300 ease  flex justify-center items-center inset-x-px inset-y-px fixed overflow-x-hidden overflow-y-hidden z-20 bg-opacity-25 bg-black">
